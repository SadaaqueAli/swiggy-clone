...
export default function Card(props) {
  ...
  return (
    <div className='w-[370px] md:w-[273px] shrink-0 mb-5'>
      <div className=' group h-[182px] rounded-[15px] overflow-hidden relative'>
        ...
        <div className='image-overlay absolute w-full h-full top-0 flex items-end p-2 text-[25px] font-bold text-white 
        tracking-tighter'>
          {props.offer}
        </div>
      </div>
